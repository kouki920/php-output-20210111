        ...
        <form action="create.php" method="post">
            ...
            <div class="form-group">
                ...
                <input type="text" name="title" id="title" class="form-control" value="<?php echo escape($review['title']); ?>">
            </div>
            <div class="form-group">
                <label for="author">著者名</label>
                <input type="text" name="author" id="author" class="form-control" value="<?php echo escape($review['author']); ?>">
            </div>
            <div class="form-group">
                <label>読書状況</label>
                <div>
            ...
            <div class="form-group">
                ...
                <input type="number" name="score" id="score" class="form-control" value="<?php echo escape($review['score']); ?>">
            </div>
            <div class="form-group">
                <label for="summary">感想</label>
                <textarea type="text" name="summary" id="summary" class="form-control" rows="10"><?php echo escape($review['summary']); ?></textarea>
            </div>
